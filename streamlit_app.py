...
def show_visualization():
    ...
    st.write("The dataset we are using comes from the survey conducted by Delphi Group and Facebook.https://delphi.cmu.edu/covidcast/?sensor=doctor-visits-smoothed_adj_cli&level=county&date=20201202&signalType=value&encoding=color&mode=export®ion=42003")
